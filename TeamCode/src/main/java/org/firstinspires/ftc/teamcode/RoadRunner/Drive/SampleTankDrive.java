...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, FL);  // Changed from "leftFront"
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, BL);   // Changed from "leftRear"
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, BR);  // Changed from "rightRear"
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, FR); // Changed from "rightFront"
